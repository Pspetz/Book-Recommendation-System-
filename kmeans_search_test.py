...
def upload_Books1(book_index):
    ...
    kmeans_books = pd.read_csv("Kmeans_books_test.csv")
    kmeans_ratings=pd.read_csv("Kmeans_ratings_test.csv")
...
def searcher1():
    ...
    book = str(input("What is the book you want to search for?\n"))
    query = {
                "match": {
                    "book_title":book
                }
