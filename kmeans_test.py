...
def kmeans_upload():
    ...
    user_csv = user_csv.dropna()
    user_csv_final = user_csv_final.dropna()
    user_csv_final
    ...
    Kmeans_BX_Ratings.to_csv('/home/spetz/Desktop/Information_Retrieval-main/Kmeans_ratings_test.csv')
    Kmeans_BX_Books.to_csv('/home/spetz/Desktop/Information_Retrieval-main/Kmeans_books_test.csv')
